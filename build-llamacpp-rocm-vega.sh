...
echo "    cp $INSTALL_DIR/lib/libggml-hip.so \"\$ROCM_DIR/\""
echo "    cp $INSTALL_DIR/lib/libggml-base.so \"\$ROCM_DIR/\""
echo "    cp $INSTALL_DIR/lib/libggml-cpu.so \"\$ROCM_DIR/\""
echo "    cp $INSTALL_DIR/lib/libllama.so \"\$ROCM_DIR/\""
echo ""
