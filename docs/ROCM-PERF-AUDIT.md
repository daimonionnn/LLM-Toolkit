...
| 4 | `-ctk q8_0` — **DONE 2026-09-08** | **+2.7 % at 1K, +6.8 % at 4K, +16.8 % at 16K, +23.5 % at 32K** | June's "+3.5 %, small" was right at 4K and wrong as a verdict: the effect scales with context. Adopt for long-context ROCm. |
| 5 | Clock pinning + COMPUTE profile — **DONE 2026-09-08, no effect** | 0 % | auto 129.63/19.11, high 130.96/19.01, COMPUTE 130.73/19.19 — all noise. June's +3 % came from a throttling GPU; the cooling fix removed the cause, SCLK now holds 2400 MHz unaided. Not adopted. |
